        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="vehicleModalLabel">اضافة مركبة</h4>
                </div>
                <form id="form_unit" action="{{ route('vehicles.store') }}" method="post">
                    @csrf
